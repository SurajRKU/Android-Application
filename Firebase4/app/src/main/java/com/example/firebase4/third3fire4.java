...
public class third3fire4 extends AppCompatActivity {
...
Intent intent;
   ...
   // Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third3fire4);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (r1.getCheckedRadioButtonId() == -1 || r2.getCheckedRadioButtonId() == -1 || r3.getCheckedRadioButtonId() == -1 || r4.getCheckedRadioButtonId() == -1 || r5.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(third3fire4.this, "Please answer all the questions", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    //Toast.makeText(third3fire4.this,user,Toast.LENGTH_SHORT).show();
                    // Toast.makeText(third3fire4.this, String.valueOf(Correctanswer), Toast.LENGTH_SHORT).show();
    ...
    public void init() {
        ...
        intent = new Intent(third3fire4.this,thirdresult.class);
        ...
        t2count = extras3.getInt("fromt2");
        rand=extras4.getInt("index")+1;
    ...
    public void updatequestion() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(third3fire4.this, "Can't fetch data from database", Toast.LENGTH_SHORT).show();
            }
        });

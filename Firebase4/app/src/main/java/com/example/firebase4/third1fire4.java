...
public class third1fire4 extends AppCompatActivity {
 ...
 //  ProgressBar progressBar;
   ...
   int t1count;
    ...
    Entity2 questionone, question2, question3, question4, question5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third1fire4);
        extras=getIntent().getExtras();
        user = extras.getString("username");
        init();
        updatequestion();
        intent1=new Intent(third1fire4.this,thrid2fire4.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (r1.getCheckedRadioButtonId() == -1 || r2.getCheckedRadioButtonId() == -1 || r3.getCheckedRadioButtonId() == -1 || r4.getCheckedRadioButtonId() == -1 || r5.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(third1fire4.this, "Please answer all the questions", Toast.LENGTH_SHORT).show();
                } else {
                   ...
                   // Toast.makeText(third1fire4.this, String.valueOf(Correctanswer), Toast.LENGTH_SHORT).show();

                    intent1.putExtra("username",user);
                    intent1.putExtra("fromt1",t1count);
                    intent1.putExtra("index",rand5);
                    //t1count=0;
                    //Toast.makeText(third1fire4.this,user,Toast.LENGTH_SHORT).show();
                    intent1.putExtra("total",Correctanswer);
...

{
   ...
   // progressBar= findViewById(R.id.progressbar);
    ...
    clear = findViewById(R.id.allclear);
      ...
      //  String sk2 = String.valueOf(rand)
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
              ...
              final Entity2 questionone = dataSnapshot.child(sk1).getValue(Entity2.class);
                Q1.setText(questionone.getQuestion());
                q1r1.setText(questionone.getOption1());
                q1r2.setText(questionone.getOption2());
                q1r3.setText(questionone.getOption3());
                q1r4.setText(questionone.getOption4());
                a1 = questionone.getAnswer().trim();
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(third1fire4.this, "Can't fetch data from database", Toast.LENGTH_SHORT).show();
            }
        });
